...
\newcommand\pic[1]{\includegraphics[trim=0 4.7 -10 0, scale=.8]{../oevelse6/Pics/#1}}
\newcommand\goodidea{\pic{goodidea}}
\newcommand\good{\pic{good}}
\newcommand\serious{\pic{seriousproblem}}
\newcommand\critical{\pic{criticalproblem}}
\newcommand\smallprob{\pic{smallproblem}}
\newcommand\filler{\pic{filler}}
...
\begin{wrapfigure}{r}{3cm}
  ...
  {\scriptsize Taget fra Flickr-brugeren MyTudut}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{3cm}
  ...
  {\scriptsize Taget fra Flickr-brugeren StephenMcleod}
\end{wrapfigure}
...
Hun er erfaren i at bruge almindelige programmer på en computer og er meget vant
...
\item[\smallprob] To af deltagerne fandt det forvirrende at der på restuarantsiden, når man var logget ind, både var et link til ``Skriv en anmeldelse'', og en boks til at skrive en anmeldelsen, længere nede på siden.  
\end{itemize}
...
\item[\smallprob] Vi havde troet at deltagerne ville søge på navnet af restauranten, men flere af deltagerne brugte samme metode som opgaven før, med at søge på bydel og køkken i stedet. Dette fungerede også, men tog en del flere klik og et sideskift ekstra.
\end{itemize}
...
\begin{figure}[hp]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth, trim=0 0 60 0]{mockup/page1.pdf}}
  \caption{Forsiden for vores prototype.}
\end{figure}

\begin{figure}[hp]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth]{mockup/page2.pdf}}
...
\begin{figure}[hp]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth, trim=0 200 0 0]{mockup/page7.pdf}}
...
\begin{figure}[hp]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth, trim=0 100 0 0]{mockup/page3.pdf}}
  \caption{Siden for en enkelt restaurant.}
\end{figure}

\begin{figure}[hp]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth, trim=0 100 0 0]{mockup/page6.pdf}}
  \caption{Siden for en enkelt restaurant når man er logget ind.}
\end{figure}

\begin{figure}[hp]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth, trim=0 100 60 0]{mockup/page4.pdf}}
...
\begin{figure}[hp]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth, trim=0 200 0 0]{mockup/page5.pdf}}
