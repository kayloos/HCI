...
Menupunkter, overskrifter. \\
Menupunkter, overskrifter osv. fra webstedet er anført i kursiv. F.eks.
Testdeltagerne havde svært ved at få øje på siden \emph{E-shop}.
...
fandt den så sent. På Figure \ref {fig:forside} kan man se hvor svært søgefeltet
er at få øje på.

\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=\textwidth]{Pics/forsidefaarup}}
...
Søgefunktionen finder ingen resultater der befinder sig på faarupbooking.dk
eller faarupshop.dk. Dette skabte problemer for en af vores deltagere der ville
finde informationer om et bestemt hotel, og hun endte med at gå ind på hotellets
egen hjemmeside.

\item[\good]{\textbf{Søgefunktionen fungerer}}

Når der blev søgt på emner der var på faarupsommerland.dk oplevede vi i langt
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=\textwidth]{Pics/faarupbooking}}
...
en fejlmeddelelse der ikke fortalte hvilken felter der ikke var udfyldt.
...
En deltager sagde at det kunne være belejligt med links inde under \emph{Parken}
der viste forlystelser egnede til børn i bestemte aldersgrupper. hun havde selv
et barn på 3 år og havde svært ved at finde forlystelser der ville passe til
dem.
...
Den engelske version af forsiden vist på Figure \ref{fig:engelskbanner} har en
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=\textwidth]{Pics/engelskbanner}}
...
\begin{figure}[htbp]
    \centering
    \fcolorbox{gray}{white}{\includegraphics[width=\textwidth]{Pics/faarupfejlside2}}
...
\begin{kommentarer}
  ...
  Som set på Figure \ref{fig:hvideblokke} oplever vi på nogle af vores PC'er at
...
vist på Figure \ref{404} som er meget sparsom på information. Desuden er
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=\textwidth]{Pics/404}}
    \caption{404 siden.}
    \label{fig:404}
\end{figure}
...
Vi lagde hurtigt mærke til at \url{faarupsommerland.dk}, \url{faarupbooking.dk}
og \url{faarupshop.dk} havde fuldstændig samme design, indgik som undersider i
\url{faarupsommerland.dk}, men hver var deres egen side. Det synes vi er
forvirrende og inkonsistent.

404-siden er ikke hjælpsom. I stedet for at forklare, at siden ikke er blevet
fundet i systemet, er fejlmeddelsesen "Siden kan ikke vises", hvilket er
...
nogen forklaring på, hvorfor man ikke kan. Samtidig bliver miniferie-kort ikke
nævnt under "Tider og priser", men kun under "Booking" og "Parken"-->"Family".
