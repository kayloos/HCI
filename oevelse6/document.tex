...
\renewcommand{\customer}{Faarup Sommerland}
\date{Oktober 2011}
...
\fancyhf{}
\fancyhead[L]{Test af Faarup Sommerlands websted}
...
hjemmesiden, samt dens to undersider \url{faarupbooking.dk} og \url{faarupshop.dk}, med udgangspunkt i oplægget fra Faarup Sommerland.
...
\begin{itemize}
  ...
  Størstedelen af vores deltagere syntes godt om sidens skovtema, og syntes at det var sjovt. En enkelt syntes at det var fjollet, men at det passede rigtigt godt til siden. 
  \item \textbf{Mange informationer}\\
  Alle vores deltagere havde, efter testen, et indtryk af alle de informationer de ledte efter var tilgængelige på siden. 
  \item \textbf{Booking er nemt}
  Alle deltagere fandt hurtigt frem til booking-siden, hvor de alle fandt og forstod at bruge ``Bestil din ferie her''-boksen. Én deltager havde problemer med dette, men det skyldtes højst sandsynligvis at booking ikke er åbent endnu.
\end{itemize}

\noindent De væsentligste punkter hvor webstedet kan fungere bedre:
\begin{itemize}
  \item \textbf{Hovedside og undersider}\\
  At brugeren både skal orientere sig på \url{faarupsommerland.dk}, \url{faarupbooking.dk} og \url{faarupshop.dk} skabte mange kvaler for vores testdeltagere. \\
  Forbedringsforslag:

  \item \textbf{Menupunkterne forklarer ikke hvad de indeholder}\\
  Menupunkterne på hovedsiden har overlappende navne og informationsområder. Vi oplevede ved alle brugere, ved mange af opgaverne, at deltageren ikke vidste hvilken fane de skulle trykke på. De endte ofte med at klikke mange faner igennem.\\
  Forbedringsforslag:

  \item \textbf{Søgefunktionen bliver ikke brugt}\\
  Søgefunktionen er meget skjult på siden, og de fleste af vores deltagere fandt den først sent i testen. I næsten alle tilfælde fandt deltagerne det de ledte efter ved hjælp af søgefunktionen, men brugte den ikke ofte, fordi den var svær at finde.\\
  Forbedringsforslag:
...
\item[\smallproblem]{\textbf{Faarup Sommerland-logoet fører ikke altid til forsiden}}

På bookingportalen og webshoppen bliver man ikke ført til hovedsiden hvis man
klikker på Faarup Sommerland-logoet. Et par testdeltagere løb ind i dette problem
...
deltagerene sagde at de ville have givet op og ringet til Faarup Sommerland i
stedet.
...
pølser. Faarup Grillens side er det sted de fleste kiggede for information om
...
Siden Faarup Sommerland fortalte at deres hovedmålgruppe var børnefamilier med specielt fokus på mødrene, er det også dem vi har gået efter som testpersoner.
...
\begin{opgaver}
\item Har du været i Faarup Sommerland før? Hvis ja, hvor ofte? Og hvad synes du
om det?
...
\item Har du brugt Faarup Sommerlands hjemmeside før?
...
\paragraph{Opgaver}
\begin{opgaver}
\item Find Faarup Sommerlands hjemmeside.
...
\item {\it Åbent spørgsmål}
    ...
    besøg i Faarup Sommerland. Hvis du skulle besøge Faarup Sommerland, hvilke
    oplysninger har du brug for? Find disse oplysninger på Faarup Sommerlands
    hjemmeside.
...
\item {\it Åbningstider/sæson}
    \begin{opgaver}
    \item Du overvejer at tage til Faarup Sommerland. Find ud af hvornår de har
...
\item {\it Priser}
    ...
    \note{Faarup Sommelands største målgruppe er børnefamilier. \\ Billetpriser findes under menupunktet ``Tider og Priser''}
...
\item {\it Bestil billetter}
    \begin{opgaver}
    \item Bestil billetter til Faarup Sommerland for din familie næste weekend.
...
\item {\it Adresse/rutevejledning}
    \begin{opgaver}
    \item Find Faarup Sommerlands adresse og find ud af hvordan du nemmest
    kommer dertil.
    \note{Faarup Sommerland ligger midt ude i en skov. Derfor er der vigtigt at kunne finde vej. \\ Findes under ``Planlæg dit besøg'' $\rightarrow$ ``Find vej'' $\rightarrow$ ``Kørselsbeskrivelser'' $\rightarrow$ ``Find den korteste rute her'' $\rightarrow$ brug Kraks ruteplanlægger.}
    \end{opgaver}

\item {\it Sovemuligheder/spisemuligheder}
    \begin{opgaver}
    \item Du har besluttet dig for at dig og din familie gerne vil bruge 2 dage
    i Faarup Sommerland. Find prisen for et ophold med overnatning på et hotel
    startende den 20. december.
    \note{Faarup Sommerland ønsker at siden fører brugerne naturligt over til bookingsiden. \\ Man skal vælge ``Overnatning'', udfylde ``Bestil din ferie her''-boksen, og så scroll'e ned eller vælge hotel i højre side.}
    \item Du ved et af dine familiemedlemmer elsker pølser, og ikke kan undvære det i en familietur. Kan man få pølser i Faarup Sommerland?
...
\item {\it Forlystelser/attraktioner}
    \begin{opgaver}
    \item Din nevø vil meget gerne prøve rutsjebanen Lynet i Faarup Sommerland.
...
\item {\it Find billetter/bedste tilbud}
    ...
    4-dages tur til Faarup Sommerland med hans kone og to børn. De har selv et
    sommerhus de vil bo i. Hjælp ham med at finde ud af hvad det vil koste.
    \note{Kan brugerne finde ud af bruge Faarups special billetter? \\ Almindelig billetter kan findes under ``Tider og Priser''. Miniferie-kort ville passe godt, men findes kun under booking og ingen klar pris kan nævnes.}
    \end{opgaver}
...
\note{Ingen af disse opgaver kan løses, da vi ikke har mulighed for at foretage en booking hos Faarup Sommerland}
    \begin{opgaver}
...
\item {\it Sæsonkort}
    \begin{opgaver}
    \item Du har været så glad for Faarup Sommerland at du gerne vil have et
...
\item {\it Diverse}
    \begin{opgaver}
    \item Har Faarup Sommerland nogle ledige stillinger?
    \note{Mange unge arbejder i Faarup sommeren over. \\ Pt. ingen ledige stillinger.}
    \item Må man medbringe sit eget mad og drikke til Faarup Sommerland?
    \note{Det må man godt.}
    \item Børnene der skal med på turen begynder at blive meget utålmodige, og
    de har brug for noget underholdning. Har Faarup Sommerland noget
...
problem for \emph{Faarup Sommerlands} normale besøgende, og dermed også
vigtigere for \emph{Faarup Sommerland} at rette.
