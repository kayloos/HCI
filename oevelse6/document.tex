...
\begin{itemize}
    ...
    \item \textbf{Gør søgefunktionen mere synlig}\\
        ...
        sider, også på bookingportaler og e-shoppen. Søgefunktionen udvides så
        den også søger på indhold i bookingportalen og e-shoppen.
\end{itemize}
...
\kommentar{\seriousproblem}{Link til søgesiden er for usynlig}
...
virkede da siden var åbnet et nyt vindue), nogle prøvede at klikke på Fårup
Sommerland logoet og én valgte til sidst at indtaste \url{faarupsommerland.dk} i
adressefeltet
...
\kommentar{\goodidea}{Siden husker ikke hotellet man ønsker at bestille}

En af testdeltagerne prøvede at lave en booking ved først at finde hotellet
under \emph{Overnatningssteder}. Da hun trykkede \emph{Bestil} hotellets side,
forventede hun at det tog det hende ind på bookingsiden for det hotel, men hun
blev ført til forsiden af bookingportalen hvor den havde glemt hvilket hotel
hun havde valgt.
...
\begin{forslag}
Hvor der er meget tekst kunne man skrive et kort resumé inden teksten.
Derudover kunne man fremhæve nøgleordene enten med fed tekst eller
understregning. 
\end{forslag}
...
blev mødt af en side med irrelevant tekst se Figur \ref{fig:findvej}. En af
...
\emph{Find vej}. Dog var der en der blev glad for kørselsbekrivelserne der kan ses på Figur \ref{fig:koerselsbeskrivelse}.
...
Højdeguiden er et screenshot af et Microsoft Excel ark. Flere deltagere
studsede lidt over det og en af vores deltagere prøvede at lukke screenshottet
...
% pølser, men en masse information om hvordan grillen ikke er. De
...
vendte heller ikke tilbage til forsiden i løbet at testen, undtagen når de skulle
tilbage fra enten booking- eller e-shopsiden.

\begin{forslag}
Fårup Sommerland ønsker at deres side leder brugerne hen på e-shoppen og
booking-siden. Et foreslag ville være at lave en boks på forsiden med
henvisning til disse. En anden mulighed ville være at lave en boks på forsiden
med henvisninger til de hyppigst brugte dele af siden, så som åbningstider
eller pris. Vi ville også anbefale at ændre det skiftende banner, da det fylder
rigtigt meget af siden og ikke videregiver særligt meget vigtigt information.
\end{forslag}
...
man slipper for at navigere rundt og lede på siden. Det skal dog lige i mente at den engelskes forsides banner har en film der automatisk afspilles med lyd. Hvis filmen skal beholdes skal lyden være sat fra indtil brugeren trykker på lyd knappen.
\end{kommentarer}
...
\begin{kommentarer}
  \kommentar{\good}{Skovtemaet er godt}
  ...
  \kommentar{\good}{Siden er troværdig}
  
  Alle deltagerne syntes at siden virker troværdig og ville ikke have noget
  problem med at lave bestillinger på siden. Én deltager nævnte at e-mærket
  (eller noget ligende) ville gøre hende mere tryk.
...
\begin{kommentarer}
    ...
    felt, hvor overskriften skulle være.

    \begin{figure}[htbp]
        \centering
        \fbox{\includegraphics[scale=0.4]{Pics/HvideBlokke}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{Pics/404}}
    \caption{404 siden.}
    \label{fig:404}
\end{figure}
\end{kommentarer}
...
fravalgte dette da vi vurderede at arbejdsbyrden ville være alt for høj i forhold
...
Testdeltagerne levede op til følgende krav:
\begin{itemize}
\item Kvinder
\item Har børn
\end{itemize}
...
internettet?
\item I hvilken grad bruger du internettet til at undersøge et sted, før du
...
\item {\it Åbent spørgsmål}
    ...
    \item {\it Åbningstider/sæson}
        ...
        \item Du overvejer at tage til Fårup Sommerland. Find ud af hvornår de har
            ...
            valgt?
            \note{Åbningstiderne er en essentiel oplysning på hjemmesiden. \\ Åbningstiderne for de
            forskellige dele af sæsonen findes under menupunktet ``Tider og Priser'', i bunden af
            siden.}
        \end{opgaver}
    \end{samepage}
...
\item {\it Adresse/rutevejledning}
    ...
    kommer dertil.
    \note{Fårup Sommerland ligger midt ude i en skov. Derfor er der vigtigt at kunne finde
    vej. \\ Findes under ``Planlæg dit besøg'' $\rightarrow$ ``Find vej'' $\rightarrow$
    ``Kørselsbeskrivelser'' $\rightarrow$ ``Find den korteste rute her'' $\rightarrow$ brug
    Kraks ruteplanlægger.}
    \end{opgaver}
...
\item {\it Sovemuligheder/spisemuligheder}
    ...
    Man skal vælge ``Overnatning'', udfylde ``Bestil din ferie her''-boksen, og så scrolle
    ned eller vælge hotel i højre side.}
...
\item {\it Find billetter/bedste tilbud}
    ...
    \note{Kan brugerne finde ud af bruge Fårups special billetter? \\ Almindelig billetter kan
    findes under ``Tider og Priser''. Miniferie-kort ville passe godt, men findes kun under
    booking og ingen klar pris kan nævnes.}
    \end{opgaver}
...
\item {\it Se betingelser for ophold}
    ...
    \note{Forståelige betingelser kan være med til at øge sidens troværdighed. \\ >30 dage inden: 300 kr. gebyr; 30--8 dage inden: 50\% af prisen; <8 dage inden: ingen godtgørelse.}
    \end{opgaver}
...
\item Fandt du siden troværdig? Ville du have tiltro til at bruge \url{faarupbooking.dk} eller \url{faarupshoppen.dk}? Hvad kunne gøre den mere troværdig?
...
I tabel \ref{tbl:oversigt} ses en oversigt over hvilke opgaver de enkelte
deltagere nåede. Der hvor opgaven blev nået, viser symbolet for svært deltageren
havde ved løse opgaven.
\begin{small}
\begin{itemize}
    \renewcommand\pic[1]{\includegraphics[trim=0 4.5 0 0,scale=.6]{Pics/#1}}
    \item[\good] Løst uden problemer. Dette symbol anvendes også, hvis deltageren korrekt finder ud af at oplysningen ikke findes på webstedet.
    \item[\smallproblem] Løst med småproblemer.
    \item[\seriousproblem] Løst, men der optrådte alvorlige problemer undervejs, som forsinkede deltageren væsentligt.
    \item[\criticalproblem] Deltageren opgav at løse opgaven eller nåede et resultat, som afveg væsentligt fra det ønskede.
    \item[\scriptsize (blank)] Opgaven blev sprunget over.
    \item[---] Deltageren ville ikke bruge Fårup Sommerland til at løse denne opgave.
\end{itemize}
\end{small}
\begin{center}
...
\scalebox{0.8}{\begin{tabular}{l@{\hspace{1.5cm}}c@{\hspace{6mm}}c@{\hspace{6mm}}c@{\hspace{6mm}}c@{\hspace{6mm}}c}
    \toprule
    ...
    10. Afbestillingsbetingelser    & \good            & \good            & \smallproblem   & \good           & \good            \\ [3mm]
...
var deres egen side. Det synes vi er forvirrende.

404-siden er ikke hjælpsom. I stedet for at forklare, at siden ikke er
blevet fundet i systemet, er fejlmeddelelsen ``Siden kan ikke vises'', hvilket er
...
Når vi sammenligner vores første inspektion med vores resultater fra
...
Vi syntes generelt at det har været en lærerig øvelse. I forhold til øvelse 4
var denne betydeligt bedre, da vi havde et mere færdigt produkt at teste. Det
giver mere frihed til at lave realistiske, åbne og omfattende opgaver. Der er
meget arbejde involveret i at lave disse tests og også i den efterfølgende
analyse. Vi havde nogen gange svært ved ikke at give hjælp når vi kunne se at
en testdeltager havde meget svært ved en opgave. Det kunne vi godt tænke os at
være bedre til, næste gang. 

Vi er ikke helt tilfredse med de udgaver af Fårups sider, vi har skulle bruge.
At bede os om at teste e-shoppen grundigt, og samtidigt lukke den, er ikke så
godt. Det samme gælder til dels for booking-siden, hvor det heller ikke var
alle søgeforespørgelser der fungere. Det har selvfølgelig også sat sit præg på
testene og vores resultater.
