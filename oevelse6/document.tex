...
\emph{Find vej}. Dog var der en der blev glad for kørselsbekrivelserne der kan ses på Figure \ref{fig:koerselsbeskrivelse}.
...
\item {\it Sovemuligheder/spisemuligheder}
    ...
    Man skal vælge ``Overnatning'', udfylde ``Bestil din ferie her''-boksen, og så scroll'e
...
I table \ref{tbl:oversigt} ses en oversigt over hvilke opgaver de enkelte
...
meget arbejde indvolveret i at lave disse tests og også i den efterfølgende
...
At bede os om at teste e-shoppen grundtigt, og samtidigt lukke den, er ikke så
