...
\newcommand\pic[1]{\includegraphics[trim=0 7 -10 0, scale=]{Pics/#1}}
...
\item {\it Adresse/rutevejledning}
    ...
    kommer dertil.
    \note{Findes under ``Planlæg dit besøg'' $\rightarrow$ ``Find vej'' $\rightarrow$ ``Kørselsbeskrivelser'' $\rightarrow$ ``Find den korteste rute her'' $\rightarrow$ brug Kraks ruteplanlægger.}
    \end{opgaver}
...
\item {\it Se reviews af opholdssteder}
    ...
    \note{Under ``Overnatning'' $\rightarrow$ ``Overnatningssteder'' $\rightarrow$ ``Blokhus Klit Golf'' $\rightarrow$ ``Se bedømmelser''}
    \end{opgaver}
